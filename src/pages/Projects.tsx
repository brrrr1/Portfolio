...
// Image URLs from Imgur
const LAGRADA_BACK_URL = 'https://imgur.com/6bboe4u';
const LAGRADA_FRONT_URL = 'https://imgur.com/wZRNz0q';
const PIPOCAPP_URL = 'https://imgur.com/7kGmH0m';
